...
public class TileEntityJadeFurnace extends TileEntity implements ISidedInventory, ITickable {
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.jade_furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                ErthiliaJadeFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    {
        return "erthilia:jade_furnace";
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new ContainerJadeFurnace(playerInventory, this);
    }
