...
public class ErthiliaJadeChest extends BlockContainer implements IErthiliaCustomModel {
		
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    protected static final AxisAlignedBB JADE_CHEST_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.875D, 0.9375D);

    public ErthiliaJadeChest(int harvestLevel)
    {
        super(Material.ROCK);
    ...
    {
    	return Item.getItemFromBlock(ErthiliaBlocks.JADE_CHEST);
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        {
        	TileEntityJadeChest tile = (TileEntityJadeChest) worldIn.getTileEntity(pos);
    ...
    {
        return new TileEntityJadeChest();
    }
