...
import fr.karmaowner.erthilia.block.state.ErthiliaPistonStructureHelper;
...
public class ErthiliaPistonBase extends BlockPistonBase {
    ...
    public ErthiliaPistonBase(boolean isSticky)
    {
    	super(isSticky);
    ...
    private void checkForMove(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            if ((new ErthiliaPistonStructureHelper(worldIn, pos, enumfacing, true)).canMove())
            {
    ...
    private boolean doMove(World worldIn, BlockPos pos, EnumFacing direction, boolean extending)
    {
        ...
        ErthiliaPistonStructureHelper blockpistonstructurehelper = new ErthiliaPistonStructureHelper(worldIn, pos, direction, extending);
