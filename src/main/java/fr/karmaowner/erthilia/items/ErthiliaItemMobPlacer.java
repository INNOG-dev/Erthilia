...
public class ErthiliaItemMobPlacer extends ItemMonsterPlacer {
	    ...
	    public ErthiliaItemMobPlacer()
	    {
	        super();
	    }
	    
	    public ErthiliaItemMobPlacer(String parEntityToSpawnName)
	    {
	    ...
	    @Override
	    protected double getYOffset(World worldIn, BlockPos blockPos)
	    {
