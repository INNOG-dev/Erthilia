package fr.karmaowner.erthilia.block.state;
...
public class ErthiliaPistonStructureHelper {
	    ...
	    public ErthiliaPistonStructureHelper(World worldIn, BlockPos posIn, EnumFacing pistonFacing, boolean extending)
	    {
	        this.world = worldIn;
	    ...
	    public boolean canMove()
	    {
	        ...
	        if (!ErthiliaPistonBase.canPush(iblockstate, this.world, this.blockToMove, this.moveDirection, false, this.moveDirection))
	        {
	    ...
	    private boolean addBlockLine(BlockPos origin, EnumFacing p_177251_2_)
	    {
	        ...
	        else if (!ErthiliaPistonBase.canPush(iblockstate, this.world, origin, this.moveDirection, false, p_177251_2_))
	        {
	            return true;
	        }
	        ...
	        else
	        {
	            ...
	            else
	            {
	                while (block.isStickyBlock(iblockstate))
	                {
	                    ...
	                    if (iblockstate.getBlock().isAir(iblockstate, this.world, blockpos) || !ErthiliaPistonBase.canPush(iblockstate, this.world, blockpos, this.moveDirection, false, this.moveDirection.getOpposite()) || blockpos.equals(this.pistonPos))
	                    {
	                        break;
	                    }
	                ...
	                while (true)
	                {
	                    ...
	                    if (!ErthiliaPistonBase.canPush(iblockstate, this.world, blockpos1, this.moveDirection, true, this.moveDirection) || blockpos1.equals(this.pistonPos))
	                    {
	                        return false;
	                    }
