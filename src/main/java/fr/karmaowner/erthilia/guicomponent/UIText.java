...
public class UIText extends GraphicObject
{
	...
	{
		this.size = size;
		this.setWidth((int)(getMinecraft().fontRenderer.getStringWidth(text)*size));
		this.setHeight((int)(getMinecraft().fontRenderer.FONT_HEIGHT*size));
	}
	...
	{
		return (int) (getMinecraft().fontRenderer.FONT_HEIGHT*size);
	}
	
	public int getTextWidth()
	{
		return (int) (getMinecraft().fontRenderer.getStringWidth(text)*size);
	}
