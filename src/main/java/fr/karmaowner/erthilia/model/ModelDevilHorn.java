...
public class ModelDevilHorn extends ModelBaseHead {
	...
	private final ResourceLocation texture = new ResourceLocation("erthilia","textures/cosmetics/devil_horn.png");
	...
	public ModelDevilHorn() 
	{
		...
		bone.cubeList.add(new ModelBox(bone, 0, 0, -1.25F, -1.0F, -2.5F, 4, 3, 4, 0.0F, false));

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone.addChild(bone4);
		setRotationAngle(bone4, 0.0F, 0.0F, 0.2182F);
		bone4.cubeList.add(new ModelBox(bone4, 0, 7, -1.0F, -3.0F, -2.0F, 3, 3, 3, 0.0F, false));

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(-1.75F, 0.0F, -0.5F);
		bone4.addChild(bone2);
		setRotationAngle(bone2, 0.0F, 0.0F, 0.4363F);
		bone2.cubeList.add(new ModelBox(bone2, 10, 11, 0.0F, -6.0F, -1.0F, 2, 3, 2, 0.0F, false));

		bone3 = new ModelRenderer(this);
		bone3.setRotationPoint(-2.5F, -4.0F, -0.5F);
		bone2.addChild(bone3);
		setRotationAngle(bone3, 0.0F, 0.0F, 0.6981F);
		bone3.cubeList.add(new ModelBox(bone3, 0, 0, 1.0F, -6.0F, 0.0F, 1, 3, 1, 0.0F, false));

		bone5 = new ModelRenderer(this);
		bone5.setRotationPoint(4.0F, -8.0F, -1.0F);
		setRotationAngle(bone5, 0.2182F, 0.0F, 0.48F);
		bone5.cubeList.add(new ModelBox(bone5, 0, 0, -2.75F, -1.0F, -2.5F, 4, 3, 4, 0.0F, true));

		bone6 = new ModelRenderer(this);
		bone6.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone5.addChild(bone6);
		setRotationAngle(bone6, 0.0F, 0.0F, -0.2182F);
		bone6.cubeList.add(new ModelBox(bone6, 0, 7, -2.0F, -3.0F, -2.0F, 3, 3, 3, 0.0F, true));

		bone7 = new ModelRenderer(this);
		bone7.setRotationPoint(1.75F, 0.0F, -0.5F);
		bone6.addChild(bone7);
		setRotationAngle(bone7, 0.0F, 0.0F, -0.4363F);
		bone7.cubeList.add(new ModelBox(bone7, 10, 11, -2.0F, -6.0F, -1.0F, 2, 3, 2, 0.0F, true));

		bone8 = new ModelRenderer(this);
		bone8.setRotationPoint(2.5F, -4.0F, -0.5F);
		bone7.addChild(bone8);
		setRotationAngle(bone8, 0.0F, 0.0F, -0.6981F);
		bone8.cubeList.add(new ModelBox(bone8, 0, 0, -2.0F, -6.0F, 0.0F, 1, 3, 1, 0.0F, true));
	}
