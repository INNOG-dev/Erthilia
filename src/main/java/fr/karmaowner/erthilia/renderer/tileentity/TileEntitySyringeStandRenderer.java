...
import fr.karmaowner.erthilia.model.ModelSyringeStand;
...
public class TileEntitySyringeStandRenderer extends TileEntitySpecialRenderer<TileEntitySyringeStand> 
{

	private final ModelSyringeStand standModel = new ModelSyringeStand();

	 public void render(TileEntitySyringeStand te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
	    {
